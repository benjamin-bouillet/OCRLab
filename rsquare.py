...
class Rsquare:
    """ Classe permettant la gestion des cases (obstacles et vides) du roboc.
    Le comportement de cette classe est celui d'une case vide."""
    ...
    def access(self, coord, action):
        """Methode définissant le comportement de l'obstacle lorsque le joueur
        essaie de se déplacer sur sa position"""
